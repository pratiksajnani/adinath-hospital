...
const I18N = {
    ...
    translations: {
        ...
        expect_title: { en: 'Your Visit Journey', hi: 'आपकी मुलाकात का सफर', gu: 'તમારી મુલાકાતની યાત્રા' },
        expect_subtitle: { en: 'From booking to recovery, we are with you every step', hi: 'बुकिंग से लेकर रिकवरी तक, हम हर कदम पर आपके साथ हैं', gu: 'બુકિંગથી રિકવરી સુધી, અમે દરેક પગલે તમારી સાથે છીએ' },
        step1_title: { en: 'Book Appointment', hi: 'अपॉइंटमेंट बुक करें', gu: 'એપોઇન્ટમેન્ટ બુક કરો' },
        step1_desc: { en: 'Call, WhatsApp, or book online', hi: 'कॉल, WhatsApp या ऑनलाइन बुक करें', gu: 'કૉલ, WhatsApp અથવા ઓનલાઇન બુક કરો' },
        step2_title: { en: 'Visit Hospital', hi: 'हॉस्पिटल आएं', gu: 'હોસ્પિટલ આવો' },
        step2_desc: { en: 'Comfortable waiting area', hi: 'आरामदायक प्रतीक्षा क्षेत्र', gu: 'આરામદાયક વેઇટિંગ એરિયા' },
        step3_title: { en: 'Consultation', hi: 'परामर्श', gu: 'પરામર્શ' },
        step3_desc: { en: 'Expert diagnosis and treatment', hi: 'विशेषज्ञ निदान और उपचार', gu: 'નિષ્ણાત નિદાન અને સારવાર' },
        step4_title: { en: 'Follow-up Care', hi: 'फॉलो-अप देखभाल', gu: 'ફોલો-અપ સંભાળ' },
        step4_desc: { en: 'Recovery support and guidance', hi: 'रिकवरी सहायता और मार्गदर्शन', gu: 'રિકવરી સપોર્ટ અને માર્ગદર્શન' },
        ...
        corner_title: { en: 'Why Joint Preservation Matters', hi: 'जोड़ों का संरक्षण क्यों महत्वपूर्ण है', gu: 'સાંધાનું સંરક્ષણ શા માટે મહત્વનું છે' },
        corner_desc: { en: 'My 35 years of experience have taught me that prevention is always better than replacement...', hi: 'मेरे 35 वर्षों के अनुभव ने मुझे सिखाया है कि रोकथाम हमेशा प्रतिस्थापन से बेहतर है...', gu: 'મારા 35 વર્ષના અનુભવે મને શીખવ્યું છે કે નિવારણ હંમેશા રિપ્લેસમેન્ટ કરતાં સારું છે...' },
        ...
        hours_full: { en: 'Monday - Saturday: 11 AM - 7 PM', hi: 'सोमवार - शनिवार: 11 AM - 7 PM', gu: 'સોમવાર - શનિવાર: 11 AM - 7 PM' },
